...
import { AuthService } from '../../../../auth-service/src/auth/auth.service';
import { WaitlistService } from '../../../../auth-service/src/waitlist/waitlist.service';
import { NotificationService } from '../../../../auth-service/src/notification/notification.service';
import { NatsClient } from '@file-sharing-app/common';
import { User } from '../../../../auth-service/src/auth/schema/user.schema';
import { Account } from '../../../../auth-service/src/auth/schema/account.schema';
import { RefreshToken } from '../../../../auth-service/src/auth/schema/refreshToken.schema';
import { EmailVerification } from '../../../../auth-service/src/auth/schema/emailVerification.schema';
import { PasswordReset } from '../../../../auth-service/src/auth/schema/passwordReset.schema';
import { RegisterDto } from '../../../../auth-service/src/auth/dto/register.dto';
import { LoginDto } from '../../../../auth-service/src/auth/dto/login.dto';
import { VerifyEmailDto } from '../../../../auth-service/src/auth/dto/verify-email.dto';
import { ProviderEnum } from '../../../../auth-service/src/auth/enums/provider.enum';
